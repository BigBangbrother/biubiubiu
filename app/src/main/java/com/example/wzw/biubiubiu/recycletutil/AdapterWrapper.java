        ...
        extends RecyclerView.Adapter
{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_LOAD) {
            if (mWrapperHolder == null) {
                mWrapperHolder = new WrapperHolder(View.inflate(parent.getContext(),
                                                                R.layout.item_load,
                                                                null));
            }
            ...
            extends RecyclerView.ViewHolder
    {
        ...
        TextView    mItemLoadTv;
        @Bind(R.id.item_load_pb)
        ProgressBar mItemLoadPb;
        ...
        void setLoadText(CharSequence text) {
            mItemLoadTv.setText(text);
        }

        void setLoadPbVisibility(boolean show) {
            mItemLoadPb.setVisibility(show
                                  ? View.VISIBLE
                                  : View.GONE);
        }
    }
